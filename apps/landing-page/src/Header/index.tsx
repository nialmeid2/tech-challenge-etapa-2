    ...
    return <header className="p-[1.25em] w-[100%] bg-black text-green-bytebank">
        <Container>
            <section className="gap-[3em] max-[850px]:gap-[2em] flex flex-row items-center justify-between max-[671px]:hidden">
                <h1 className="">
                    <Image src="/home/brand.svg" alt="Byte bank" className="max-[850px]:hidden" />
                    <Image src="/home/logo.svg" alt="Byte bank" className="min-[851px]:hidden h-[3em] max-[671px]:hidden" />
                </h1>
            ...
            <section className="min-[672px]:hidden align-middle">
                <Image src="/home/menu.svg" alt="Abrir Menu" className="h-[2em]" />
            </section>
            ...
            <section className="min-[672px]:hidden align-middle">
                <Image src="/home/brand.svg" alt="Byte bank" className="h-[2em]" />
            </section>
        </Container>
    </header>
}